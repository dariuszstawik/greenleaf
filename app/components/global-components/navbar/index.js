...
const Navbar = () => {
  ...
  return (
    <div className="border-b-2 border-b-gray-100 text-xl fixed w-screen h-28 flex justify-between items-center px-10 lg:px-16 py-4 bg-gray-50 top-0 left-0 z-50">
